...
int main()
{
  TreeMap <int,char*>* h1=new TreeMap<int,char*>();
  ...
  cout<<"contains ce "<<h1->containsValue("ce")<<endl;
  cout<<"contains fat "<<h1->containsValue("fat")<<endl;
  cout<<"get value at 10 "<<h1->get(10)<<endl;
